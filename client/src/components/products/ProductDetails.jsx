...
//     // For example, fetch products related to the shop
//     // const fetchProducts = async () => {
//     //   const response = await axios.get(`/api/products/shop/${data.shop._id}`);
...
//       prevWishlist.filter((item) => item._id !== data._id)
//     );
//   };
